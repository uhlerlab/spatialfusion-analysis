...
This folder contains analysis notebooks for benchmarking breast cancer (BRCA) spatial transcriptomics embeddings, as used in Figure 3 of the SpatialFusion project.
...
- Outputs such as plots and CSVs are saved to the `results/figures_Fig3/` directory by default.
